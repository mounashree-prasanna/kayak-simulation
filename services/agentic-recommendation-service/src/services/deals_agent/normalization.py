...
class NormalizationStage:
    ...
    def normalize_availability(self, avail_str: Any) -> int:
        ...
        if isinstance(avail_str, str):
            # Handle text numbers like "one", "two", etc.
            text_to_number = {
                "one": 1, "two": 2, "three": 3, "four": 4, "five": 5,
                "six": 6, "seven": 7, "eight": 8, "nine": 9, "ten": 10
            }
            avail_lower = avail_str.lower().strip()
            if avail_lower in text_to_number:
                return text_to_number[avail_lower]
    ...
    async def normalize_record(self, raw_record: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if listing_type == "Hotel":
            ...
            normalized.update({
                ...
                "rooms_left": self.normalize_availability(rooms_available) if rooms_available else 0,
            ...
            normalized.update({
                ...
                "stops": self.normalize_availability(stops) if stops else 0,
            })
