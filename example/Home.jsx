    ...
    <div className="home">
      <div className="hero-section">
        <div className="hero-content">
          ...
          <div className="ai-mode-container">
            <button className="ai-mode-btn" onClick={scrollToAgent}>
              <span className="ai-mode-icon">✨</span>
              <span className="ai-mode-text">AI Mode</span>
            </button>
          </div>
      ...
      <div className="agent-section" ref={agentSectionRef}>
        <div className="container">
          <h2 className="section-title">AI Travel Concierge</h2>
          <p className="section-subtitle">Let our AI assistant find the perfect travel bundles for you</p>
          <TravelAgent />
        </div>
      </div>
