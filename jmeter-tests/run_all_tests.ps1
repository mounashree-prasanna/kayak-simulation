# JMeter Test Runner Script - Run all 4 combinations
...
if ($allSuccess) {
    ...
    Write-Host "`nResults: $ResultsDir" -ForegroundColor Yellow
    Write-Host "Reports: $ReportsDir" -ForegroundColor Yellow
    Write-Host "`nNext step: Run generate_comparison_charts.py to create charts" -ForegroundColor Cyan
} else {
